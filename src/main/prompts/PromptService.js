class PromptService {
     ...
     */
    getRewritePrompt() {
        return `WRITER DIRECTIVE: You are a professional editor and proofreader.
     ...
     */
    getReplyPrompt() {
        return 'WRITER DIRECTIVE: Read the message on screen. GENERATE a substantive, high-IQ, and natural human reply (20-50 characters). NO robotic brevity. NO meta-talk. OUTPUT ONLY THE RESPONSE.';
    }
     ...
     */
    getAutoFillPrompt() {
        return 'WRITER DIRECTIVE: GENERATE a complete, substantive, and natural human-like value or response for the active field/chat (20-50 characters). NO robotic fillers like \'Got it\' or \'Ok\'. OUTPUT ONLY THE TEXT.';
    }
